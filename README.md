...
Java 17 is the supported development and CI baseline. Newer Java versions may run the application, but Maven, Gradle, Gitpod, Codespaces, and CI are aligned on Java 17.
